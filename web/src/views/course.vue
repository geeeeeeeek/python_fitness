            ...
            <a-row :gutter="24">
              ...
              <a-col span="12">
                <a-form-item label="课程类型" name="course_type">
                  <a-input placeholder="请输入" v-model:value="modal.form.course_type" />
                </a-form-item>
              </a-col>
              <a-col span="12">
              ...
              <a-col span="12">
                <a-form-item label="价格" name="price">
                  <a-input placeholder="请输入" v-model:value="modal.form.price" />
                </a-form-item>
              </a-col>
              <a-col span="12">
                <a-form-item label="时长" name="duration">
                  <a-input placeholder="请输入" v-model:value="modal.form.duration" />
                </a-form-item>
              </a-col>
            </a-row>
          </a-form>
...
<script setup lang="ts">
  ...
  import { createApi, listApi, updateApi, deleteApi } from '/@/api/course';
  ...
  const handleOk = () => {
    myform.value
      ...
      .then(() => {
        ...
        formData.append('course_type', modal.form.course_type || '');
        formData.append('duration', modal.form.duration || '');
