      ...
      >
        ...
        <div style="padding-right: 16px; max-height: 480px; overflow-x: hidden; overflow-y: auto">
          <a-form ref="myform" :label-col="{ style: { width: '80px' } }" :model="modal.form" :rules="modal.rules">
            <a-row :gutter="24">
              <a-col span="12">
                <a-form-item label="器材名称" name="title">
                  <a-input placeholder="请输入" v-model:value="modal.form.title" />
                </a-form-item>
              </a-col>
              <a-col span="12">
                <a-form-item label="状态" name="status">
                  <a-input placeholder="请输入" v-model:value="modal.form.status" />
                </a-form-item>
              </a-col>
            </a-row>
          </a-form>
...
<script setup lang="ts">
  ...
  import { createApi, listApi, updateApi, deleteApi } from '/@/api/equipment';
