...
> 基于django+mysql开发的健身房管理系统，本文档包括功能说明、数据库设计、开发过程。学习过程遇到问题可以咨询作者：lengqin1024（微信）

## 功能说明

- 教练管理（包括教练的新增、查询、删除、编辑功能）
- 课程管理（包括课程的新增、查询、删除、编辑功能）
- 会员管理（包括会员的新增、查询、删除、编辑功能）
- 器材管理（包括器材的新增、查询、删除、编辑功能）
- 场地管理（包括场地信息的新增、查询、删除、编辑功能）
...
无论是用户管理、教练管理、课程管理等功能都是基于django的restframework框架开发的，开发流程是：
- 第一步：编写model模型
- 第二步：编写序列化器
- 第三步：编写view视图
- 第四步：配置url接口地址
