...
urlpatterns = [
    ...
    path('admin/equipment/list', views.admin.equipment.list_api),
    path('admin/equipment/create', views.admin.equipment.create),
    path('admin/equipment/update', views.admin.equipment.update),
    path('admin/equipment/delete', views.admin.equipment.delete),
